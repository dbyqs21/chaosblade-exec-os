...
func (o *OccupyActionSpec) Example() spec.Example {
	if o.ActionExample.Introduction != "" || o.ActionExample.Introduction != "" || o.ActionExample.ExampleCommands != nil {
		return o.ActionExample
	}
