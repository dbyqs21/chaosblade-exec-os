...
func (l *loadActionCommand) Example() spec.Example {
	if l.ActionExample.Introduction != "" || l.ActionExample.Introduction != "" || l.ActionExample.ExampleCommands != nil {
		return l.ActionExample
	}
